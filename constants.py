...
######### MORE BRICK CONSTANTS #########

#: the list of the colors of all the bricks
BRICK_COLORS = [colormodel.RED, colormodel.ORANGE, colormodel.YELLOW,
                colormodel.GREEN, colormodel.CYAN]

#: more colors to be used for the colorchange powerup
RANDOM_COLORS = [colormodel.BLUE, colormodel.DARK_GRAY, colormodel.GRAY, colormodel.MAGENTA,
                colormodel.PINK]

#: warm color palette
WARM_COLORS = [colormodel.RED, colormodel.ORANGE, colormodel.YELLOW, colormodel.MAGENTA]

# cold color palette
COLD_COLORS = [colormodel.GREEN, colormodel.BLUE, colormodel.CYAN, colormodel.GRAY]

# christmas colors palette
HOLIDAY_COLORS = [colormodel.RED, colormodel.GREEN]

# list of all the palettes
PALETTES = [BRICK_COLORS, RANDOM_COLORS, WARM_COLORS, COLD_COLORS, HOLIDAY_COLORS]

#the different points each brick is worth
BRICK_POINTS = [100, 50, 30, 20, 10]


######### MORE PADDLE CONSTANTS ########

#: the amount the paddle should move when a key is pressed
ANIMATION_STEP = 5
...
#: height of powerup bomb
POWERUP_WIDTH = PADDLE_WIDTH * (3 / 4.0)
...
POWERUP_SHRINK = 2
#: speed up ball powerup
POWERUP_SPEEDUP = 3
#: slow down ball powerup
POWERUP_SLOWDOWN = 4
#: destroy random bricks powerup
POWERUP_BOMB = 5
#: increase points powerup
POWERUP_GOLD = 6
#: play music powerup
POWERUP_MUSIC = 7
#: list of all powerups
POWERUPS = [POWERUP_COLOR, POWERUP_GROW, POWERUP_SHRINK, POWERUP_SPEEDUP, POWERUP_SLOWDOWN, POWERUP_BOMB, POWERUP_GOLD, POWERUP_MUSIC]
#: list of images for each powerup besides the album arts
IMAGES = ['rainbow.png', 'redpill.png', 'bluepill.png', 'lightning.png', 'snail.png', 'bomb.png', 'gold.png']
#: the album art for POWERUP_MUSIC
ALBUM_ART = ['Brick_House', 'Goodbye_Yellow_Brick_Road', 'Thick_As_A_Brick', 'Another_Brick_in_the_Wall']